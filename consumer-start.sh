...
sh kafka-topics.sh --create --topic advith --zookeeper 10.1.1.1:2181 --partitions 1 --replication-factor 1 &
sh kafka-console-consumer.sh --topic advith --zookeeper 10.1.1.1:2181
