...
void ovsrec_autoattach_add_clause_mappings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_mappings, const int64_t *value_mappings, size_t n_mappings);
void ovsrec_autoattach_add_clause_system_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_description);
void ovsrec_autoattach_add_clause_system_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_name);
void ovsrec_autoattach_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_autoattach_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_autoattach_remove_clause_mappings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_mappings, const int64_t *value_mappings, size_t n_mappings);
void ovsrec_autoattach_remove_clause_system_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_description);
void ovsrec_autoattach_remove_clause_system_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_name);
void ovsrec_autoattach_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_autoattach_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_bridge_add_clause_auto_attach(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *auto_attach);
...
void ovsrec_bridge_add_clause_controller(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **controller, size_t n_controller);
...
void ovsrec_bridge_add_clause_datapath_id(struct ovsdb_idl *idl, enum ovsdb_function function, const char *datapath_id);
void ovsrec_bridge_add_clause_datapath_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *datapath_type);
void ovsrec_bridge_add_clause_datapath_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *datapath_version);
...
void ovsrec_bridge_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_bridge_add_clause_fail_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *fail_mode);
...
void ovsrec_bridge_add_clause_flood_vlans(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *flood_vlans, size_t n_flood_vlans);
...
void ovsrec_bridge_add_clause_flow_tables(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_flow_tables, struct uuid **value_flow_tables, size_t n_flow_tables);
...
void ovsrec_bridge_add_clause_ipfix(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ipfix);
void ovsrec_bridge_add_clause_mcast_snooping_enable(struct ovsdb_idl *idl, enum ovsdb_function function, bool mcast_snooping_enable);
...
void ovsrec_bridge_add_clause_mirrors(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **mirrors, size_t n_mirrors);
void ovsrec_bridge_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void ovsrec_bridge_add_clause_netflow(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *netflow);
...
void ovsrec_bridge_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_bridge_add_clause_ports(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ports, size_t n_ports);
...
void ovsrec_bridge_add_clause_protocols(struct ovsdb_idl *idl, enum ovsdb_function function, const char **protocols, size_t n_protocols);
void ovsrec_bridge_add_clause_rstp_enable(struct ovsdb_idl *idl, enum ovsdb_function function, bool rstp_enable);
...
void ovsrec_bridge_add_clause_rstp_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_bridge_add_clause_sflow(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *sflow);
...
void ovsrec_bridge_add_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_bridge_add_clause_stp_enable(struct ovsdb_idl *idl, enum ovsdb_function function, bool stp_enable);
void ovsrec_bridge_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_bridge_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_bridge_remove_clause_auto_attach(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *auto_attach);
void ovsrec_bridge_remove_clause_controller(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **controller, size_t n_controller);
void ovsrec_bridge_remove_clause_datapath_id(struct ovsdb_idl *idl, enum ovsdb_function function, const char *datapath_id);
void ovsrec_bridge_remove_clause_datapath_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *datapath_type);
void ovsrec_bridge_remove_clause_datapath_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *datapath_version);
void ovsrec_bridge_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_bridge_remove_clause_fail_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *fail_mode);
void ovsrec_bridge_remove_clause_flood_vlans(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *flood_vlans, size_t n_flood_vlans);
void ovsrec_bridge_remove_clause_flow_tables(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_flow_tables, struct uuid **value_flow_tables, size_t n_flow_tables);
void ovsrec_bridge_remove_clause_ipfix(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ipfix);
void ovsrec_bridge_remove_clause_mcast_snooping_enable(struct ovsdb_idl *idl, enum ovsdb_function function, bool mcast_snooping_enable);
void ovsrec_bridge_remove_clause_mirrors(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **mirrors, size_t n_mirrors);
void ovsrec_bridge_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void ovsrec_bridge_remove_clause_netflow(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *netflow);
void ovsrec_bridge_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_bridge_remove_clause_ports(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ports, size_t n_ports);
void ovsrec_bridge_remove_clause_protocols(struct ovsdb_idl *idl, enum ovsdb_function function, const char **protocols, size_t n_protocols);
void ovsrec_bridge_remove_clause_rstp_enable(struct ovsdb_idl *idl, enum ovsdb_function function, bool rstp_enable);
void ovsrec_bridge_remove_clause_rstp_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_bridge_remove_clause_sflow(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *sflow);
void ovsrec_bridge_remove_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_bridge_remove_clause_stp_enable(struct ovsdb_idl *idl, enum ovsdb_function function, bool stp_enable);
void ovsrec_bridge_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_bridge_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_controller_add_clause_connection_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *connection_mode);
...
void ovsrec_controller_add_clause_controller_burst_limit(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *controller_burst_limit, size_t n_controller_burst_limit);
...
void ovsrec_controller_add_clause_controller_rate_limit(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *controller_rate_limit, size_t n_controller_rate_limit);
...
void ovsrec_controller_add_clause_enable_async_messages(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *enable_async_messages, size_t n_enable_async_messages);
...
void ovsrec_controller_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_controller_add_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe);
void ovsrec_controller_add_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected);
...
void ovsrec_controller_add_clause_local_gateway(struct ovsdb_idl *idl, enum ovsdb_function function, const char *local_gateway);
...
void ovsrec_controller_add_clause_local_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *local_ip);
...
void ovsrec_controller_add_clause_local_netmask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *local_netmask);
...
void ovsrec_controller_add_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff);
...
void ovsrec_controller_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_controller_add_clause_role(struct ovsdb_idl *idl, enum ovsdb_function function, const char *role);
...
void ovsrec_controller_add_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_controller_add_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target);
void ovsrec_controller_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_controller_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_controller_remove_clause_connection_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *connection_mode);
void ovsrec_controller_remove_clause_controller_burst_limit(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *controller_burst_limit, size_t n_controller_burst_limit);
void ovsrec_controller_remove_clause_controller_rate_limit(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *controller_rate_limit, size_t n_controller_rate_limit);
void ovsrec_controller_remove_clause_enable_async_messages(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *enable_async_messages, size_t n_enable_async_messages);
void ovsrec_controller_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_controller_remove_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe);
void ovsrec_controller_remove_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected);
void ovsrec_controller_remove_clause_local_gateway(struct ovsdb_idl *idl, enum ovsdb_function function, const char *local_gateway);
void ovsrec_controller_remove_clause_local_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *local_ip);
void ovsrec_controller_remove_clause_local_netmask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *local_netmask);
void ovsrec_controller_remove_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff);
void ovsrec_controller_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_controller_remove_clause_role(struct ovsdb_idl *idl, enum ovsdb_function function, const char *role);
void ovsrec_controller_remove_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_controller_remove_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target);
void ovsrec_controller_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_controller_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_flow_sample_collector_set_add_clause_bridge(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *bridge);
...
void ovsrec_flow_sample_collector_set_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_flow_sample_collector_set_add_clause_id(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t id);
...
void ovsrec_flow_sample_collector_set_add_clause_ipfix(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ipfix);
void ovsrec_flow_sample_collector_set_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_flow_sample_collector_set_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_flow_sample_collector_set_remove_clause_bridge(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *bridge);
void ovsrec_flow_sample_collector_set_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_flow_sample_collector_set_remove_clause_id(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t id);
void ovsrec_flow_sample_collector_set_remove_clause_ipfix(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ipfix);
void ovsrec_flow_sample_collector_set_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_flow_sample_collector_set_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_flow_table_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_flow_table_add_clause_flow_limit(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *flow_limit, size_t n_flow_limit);
...
void ovsrec_flow_table_add_clause_groups(struct ovsdb_idl *idl, enum ovsdb_function function, const char **groups, size_t n_groups);
...
void ovsrec_flow_table_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void ovsrec_flow_table_add_clause_overflow_policy(struct ovsdb_idl *idl, enum ovsdb_function function, const char *overflow_policy);
...
void ovsrec_flow_table_add_clause_prefixes(struct ovsdb_idl *idl, enum ovsdb_function function, const char **prefixes, size_t n_prefixes);
void ovsrec_flow_table_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_flow_table_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_flow_table_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_flow_table_remove_clause_flow_limit(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *flow_limit, size_t n_flow_limit);
void ovsrec_flow_table_remove_clause_groups(struct ovsdb_idl *idl, enum ovsdb_function function, const char **groups, size_t n_groups);
void ovsrec_flow_table_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void ovsrec_flow_table_remove_clause_overflow_policy(struct ovsdb_idl *idl, enum ovsdb_function function, const char *overflow_policy);
void ovsrec_flow_table_remove_clause_prefixes(struct ovsdb_idl *idl, enum ovsdb_function function, const char **prefixes, size_t n_prefixes);
void ovsrec_flow_table_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_flow_table_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_ipfix_add_clause_cache_active_timeout(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cache_active_timeout, size_t n_cache_active_timeout);
...
void ovsrec_ipfix_add_clause_cache_max_flows(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cache_max_flows, size_t n_cache_max_flows);
...
void ovsrec_ipfix_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_ipfix_add_clause_obs_domain_id(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *obs_domain_id, size_t n_obs_domain_id);
...
void ovsrec_ipfix_add_clause_obs_point_id(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *obs_point_id, size_t n_obs_point_id);
...
void ovsrec_ipfix_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_ipfix_add_clause_sampling(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *sampling, size_t n_sampling);
...
void ovsrec_ipfix_add_clause_targets(struct ovsdb_idl *idl, enum ovsdb_function function, const char **targets, size_t n_targets);
void ovsrec_ipfix_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_ipfix_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_ipfix_remove_clause_cache_active_timeout(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cache_active_timeout, size_t n_cache_active_timeout);
void ovsrec_ipfix_remove_clause_cache_max_flows(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cache_max_flows, size_t n_cache_max_flows);
void ovsrec_ipfix_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_ipfix_remove_clause_obs_domain_id(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *obs_domain_id, size_t n_obs_domain_id);
void ovsrec_ipfix_remove_clause_obs_point_id(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *obs_point_id, size_t n_obs_point_id);
void ovsrec_ipfix_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_ipfix_remove_clause_sampling(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *sampling, size_t n_sampling);
void ovsrec_ipfix_remove_clause_targets(struct ovsdb_idl *idl, enum ovsdb_function function, const char **targets, size_t n_targets);
void ovsrec_ipfix_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_ipfix_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_interface_add_clause_admin_state(struct ovsdb_idl *idl, enum ovsdb_function function, const char *admin_state);
...
void ovsrec_interface_add_clause_bfd(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_interface_add_clause_bfd_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_interface_add_clause_cfm_fault(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *cfm_fault, size_t n_cfm_fault);
...
void ovsrec_interface_add_clause_cfm_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **cfm_fault_status, size_t n_cfm_fault_status);
...
void ovsrec_interface_add_clause_cfm_flap_count(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_flap_count, size_t n_cfm_flap_count);
...
void ovsrec_interface_add_clause_cfm_health(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_health, size_t n_cfm_health);
...
void ovsrec_interface_add_clause_cfm_mpid(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_mpid, size_t n_cfm_mpid);
...
void ovsrec_interface_add_clause_cfm_remote_mpids(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_remote_mpids, size_t n_cfm_remote_mpids);
...
void ovsrec_interface_add_clause_cfm_remote_opstate(struct ovsdb_idl *idl, enum ovsdb_function function, const char *cfm_remote_opstate);
...
void ovsrec_interface_add_clause_duplex(struct ovsdb_idl *idl, enum ovsdb_function function, const char *duplex);
...
void ovsrec_interface_add_clause_error(struct ovsdb_idl *idl, enum ovsdb_function function, const char *error);
...
void ovsrec_interface_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_interface_add_clause_ifindex(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ifindex, size_t n_ifindex);
void ovsrec_interface_add_clause_ingress_policing_burst(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t ingress_policing_burst);
void ovsrec_interface_add_clause_ingress_policing_rate(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t ingress_policing_rate);
...
void ovsrec_interface_add_clause_lacp_current(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *lacp_current, size_t n_lacp_current);
...
void ovsrec_interface_add_clause_link_resets(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *link_resets, size_t n_link_resets);
...
void ovsrec_interface_add_clause_link_speed(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *link_speed, size_t n_link_speed);
...
void ovsrec_interface_add_clause_link_state(struct ovsdb_idl *idl, enum ovsdb_function function, const char *link_state);
...
void ovsrec_interface_add_clause_lldp(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_interface_add_clause_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *mac);
...
void ovsrec_interface_add_clause_mac_in_use(struct ovsdb_idl *idl, enum ovsdb_function function, const char *mac_in_use);
...
void ovsrec_interface_add_clause_mtu(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *mtu, size_t n_mtu);
...
void ovsrec_interface_add_clause_mtu_request(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *mtu_request, size_t n_mtu_request);
void ovsrec_interface_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void ovsrec_interface_add_clause_ofport(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ofport, size_t n_ofport);
...
void ovsrec_interface_add_clause_ofport_request(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ofport_request, size_t n_ofport_request);
...
void ovsrec_interface_add_clause_options(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_interface_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_interface_add_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_statistics, const int64_t *value_statistics, size_t n_statistics);
...
void ovsrec_interface_add_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_add_clause_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *type);
void ovsrec_interface_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_interface_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_interface_remove_clause_admin_state(struct ovsdb_idl *idl, enum ovsdb_function function, const char *admin_state);
void ovsrec_interface_remove_clause_bfd(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_remove_clause_bfd_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_remove_clause_cfm_fault(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *cfm_fault, size_t n_cfm_fault);
void ovsrec_interface_remove_clause_cfm_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **cfm_fault_status, size_t n_cfm_fault_status);
void ovsrec_interface_remove_clause_cfm_flap_count(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_flap_count, size_t n_cfm_flap_count);
void ovsrec_interface_remove_clause_cfm_health(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_health, size_t n_cfm_health);
void ovsrec_interface_remove_clause_cfm_mpid(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_mpid, size_t n_cfm_mpid);
void ovsrec_interface_remove_clause_cfm_remote_mpids(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *cfm_remote_mpids, size_t n_cfm_remote_mpids);
void ovsrec_interface_remove_clause_cfm_remote_opstate(struct ovsdb_idl *idl, enum ovsdb_function function, const char *cfm_remote_opstate);
void ovsrec_interface_remove_clause_duplex(struct ovsdb_idl *idl, enum ovsdb_function function, const char *duplex);
void ovsrec_interface_remove_clause_error(struct ovsdb_idl *idl, enum ovsdb_function function, const char *error);
void ovsrec_interface_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_remove_clause_ifindex(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ifindex, size_t n_ifindex);
void ovsrec_interface_remove_clause_ingress_policing_burst(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t ingress_policing_burst);
void ovsrec_interface_remove_clause_ingress_policing_rate(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t ingress_policing_rate);
void ovsrec_interface_remove_clause_lacp_current(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *lacp_current, size_t n_lacp_current);
void ovsrec_interface_remove_clause_link_resets(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *link_resets, size_t n_link_resets);
void ovsrec_interface_remove_clause_link_speed(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *link_speed, size_t n_link_speed);
void ovsrec_interface_remove_clause_link_state(struct ovsdb_idl *idl, enum ovsdb_function function, const char *link_state);
void ovsrec_interface_remove_clause_lldp(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_remove_clause_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *mac);
void ovsrec_interface_remove_clause_mac_in_use(struct ovsdb_idl *idl, enum ovsdb_function function, const char *mac_in_use);
void ovsrec_interface_remove_clause_mtu(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *mtu, size_t n_mtu);
void ovsrec_interface_remove_clause_mtu_request(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *mtu_request, size_t n_mtu_request);
void ovsrec_interface_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void ovsrec_interface_remove_clause_ofport(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ofport, size_t n_ofport);
void ovsrec_interface_remove_clause_ofport_request(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ofport_request, size_t n_ofport_request);
void ovsrec_interface_remove_clause_options(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_remove_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_statistics, const int64_t *value_statistics, size_t n_statistics);
void ovsrec_interface_remove_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_interface_remove_clause_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *type);
void ovsrec_interface_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_interface_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_manager_add_clause_connection_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *connection_mode);
...
void ovsrec_manager_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_manager_add_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe);
void ovsrec_manager_add_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected);
...
void ovsrec_manager_add_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff);
...
void ovsrec_manager_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_manager_add_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_manager_add_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target);
void ovsrec_manager_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_manager_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_manager_remove_clause_connection_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *connection_mode);
void ovsrec_manager_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_manager_remove_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe);
void ovsrec_manager_remove_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected);
void ovsrec_manager_remove_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff);
void ovsrec_manager_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_manager_remove_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_manager_remove_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target);
void ovsrec_manager_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_manager_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_mirror_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_mirror_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void ovsrec_mirror_add_clause_output_port(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *output_port);
...
void ovsrec_mirror_add_clause_output_vlan(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *output_vlan, size_t n_output_vlan);
void ovsrec_mirror_add_clause_select_all(struct ovsdb_idl *idl, enum ovsdb_function function, bool select_all);
...
void ovsrec_mirror_add_clause_select_dst_port(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **select_dst_port, size_t n_select_dst_port);
...
void ovsrec_mirror_add_clause_select_src_port(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **select_src_port, size_t n_select_src_port);
...
void ovsrec_mirror_add_clause_select_vlan(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *select_vlan, size_t n_select_vlan);
...
void ovsrec_mirror_add_clause_snaplen(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *snaplen, size_t n_snaplen);
...
void ovsrec_mirror_add_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_statistics, const int64_t *value_statistics, size_t n_statistics);
void ovsrec_mirror_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_mirror_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_mirror_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_mirror_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void ovsrec_mirror_remove_clause_output_port(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *output_port);
void ovsrec_mirror_remove_clause_output_vlan(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *output_vlan, size_t n_output_vlan);
void ovsrec_mirror_remove_clause_select_all(struct ovsdb_idl *idl, enum ovsdb_function function, bool select_all);
void ovsrec_mirror_remove_clause_select_dst_port(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **select_dst_port, size_t n_select_dst_port);
void ovsrec_mirror_remove_clause_select_src_port(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **select_src_port, size_t n_select_src_port);
void ovsrec_mirror_remove_clause_select_vlan(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *select_vlan, size_t n_select_vlan);
void ovsrec_mirror_remove_clause_snaplen(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *snaplen, size_t n_snaplen);
void ovsrec_mirror_remove_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_statistics, const int64_t *value_statistics, size_t n_statistics);
void ovsrec_mirror_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_mirror_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_netflow_add_clause_active_timeout(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t active_timeout);
void ovsrec_netflow_add_clause_add_id_to_interface(struct ovsdb_idl *idl, enum ovsdb_function function, bool add_id_to_interface);
...
void ovsrec_netflow_add_clause_engine_id(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *engine_id, size_t n_engine_id);
...
void ovsrec_netflow_add_clause_engine_type(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *engine_type, size_t n_engine_type);
...
void ovsrec_netflow_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_netflow_add_clause_targets(struct ovsdb_idl *idl, enum ovsdb_function function, const char **targets, size_t n_targets);
void ovsrec_netflow_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_netflow_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_netflow_remove_clause_active_timeout(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t active_timeout);
void ovsrec_netflow_remove_clause_add_id_to_interface(struct ovsdb_idl *idl, enum ovsdb_function function, bool add_id_to_interface);
void ovsrec_netflow_remove_clause_engine_id(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *engine_id, size_t n_engine_id);
void ovsrec_netflow_remove_clause_engine_type(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *engine_type, size_t n_engine_type);
void ovsrec_netflow_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_netflow_remove_clause_targets(struct ovsdb_idl *idl, enum ovsdb_function function, const char **targets, size_t n_targets);
void ovsrec_netflow_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_netflow_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_open_vswitch_add_clause_bridges(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **bridges, size_t n_bridges);
void ovsrec_open_vswitch_add_clause_cur_cfg(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t cur_cfg);
...
void ovsrec_open_vswitch_add_clause_datapath_types(struct ovsdb_idl *idl, enum ovsdb_function function, const char **datapath_types, size_t n_datapath_types);
...
void ovsrec_open_vswitch_add_clause_db_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *db_version);
...
void ovsrec_open_vswitch_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_open_vswitch_add_clause_iface_types(struct ovsdb_idl *idl, enum ovsdb_function function, const char **iface_types, size_t n_iface_types);
...
void ovsrec_open_vswitch_add_clause_manager_options(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **manager_options, size_t n_manager_options);
void ovsrec_open_vswitch_add_clause_next_cfg(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t next_cfg);
...
void ovsrec_open_vswitch_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_open_vswitch_add_clause_ovs_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ovs_version);
...
void ovsrec_open_vswitch_add_clause_ssl(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ssl);
...
void ovsrec_open_vswitch_add_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_open_vswitch_add_clause_system_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_type);
...
void ovsrec_open_vswitch_add_clause_system_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_version);
void ovsrec_open_vswitch_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_open_vswitch_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_open_vswitch_remove_clause_bridges(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **bridges, size_t n_bridges);
void ovsrec_open_vswitch_remove_clause_cur_cfg(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t cur_cfg);
void ovsrec_open_vswitch_remove_clause_datapath_types(struct ovsdb_idl *idl, enum ovsdb_function function, const char **datapath_types, size_t n_datapath_types);
void ovsrec_open_vswitch_remove_clause_db_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *db_version);
void ovsrec_open_vswitch_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_open_vswitch_remove_clause_iface_types(struct ovsdb_idl *idl, enum ovsdb_function function, const char **iface_types, size_t n_iface_types);
void ovsrec_open_vswitch_remove_clause_manager_options(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **manager_options, size_t n_manager_options);
void ovsrec_open_vswitch_remove_clause_next_cfg(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t next_cfg);
void ovsrec_open_vswitch_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_open_vswitch_remove_clause_ovs_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ovs_version);
void ovsrec_open_vswitch_remove_clause_ssl(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ssl);
void ovsrec_open_vswitch_remove_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_open_vswitch_remove_clause_system_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_type);
void ovsrec_open_vswitch_remove_clause_system_version(struct ovsdb_idl *idl, enum ovsdb_function function, const char *system_version);
void ovsrec_open_vswitch_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_open_vswitch_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_port_add_clause_bond_active_slave(struct ovsdb_idl *idl, enum ovsdb_function function, const char *bond_active_slave);
void ovsrec_port_add_clause_bond_downdelay(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bond_downdelay);
void ovsrec_port_add_clause_bond_fake_iface(struct ovsdb_idl *idl, enum ovsdb_function function, bool bond_fake_iface);
...
void ovsrec_port_add_clause_bond_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *bond_mode);
void ovsrec_port_add_clause_bond_updelay(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bond_updelay);
...
void ovsrec_port_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_port_add_clause_fake_bridge(struct ovsdb_idl *idl, enum ovsdb_function function, bool fake_bridge);
...
void ovsrec_port_add_clause_interfaces(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **interfaces, size_t n_interfaces);
...
void ovsrec_port_add_clause_lacp(struct ovsdb_idl *idl, enum ovsdb_function function, const char *lacp);
...
void ovsrec_port_add_clause_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *mac);
void ovsrec_port_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void ovsrec_port_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_port_add_clause_qos(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *qos);
...
void ovsrec_port_add_clause_rstp_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_rstp_statistics, const int64_t *value_rstp_statistics, size_t n_rstp_statistics);
...
void ovsrec_port_add_clause_rstp_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_port_add_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_statistics, const int64_t *value_statistics, size_t n_statistics);
...
void ovsrec_port_add_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_port_add_clause_tag(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tag, size_t n_tag);
...
void ovsrec_port_add_clause_trunks(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *trunks, size_t n_trunks);
...
void ovsrec_port_add_clause_vlan_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *vlan_mode);
void ovsrec_port_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_port_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_port_remove_clause_bond_active_slave(struct ovsdb_idl *idl, enum ovsdb_function function, const char *bond_active_slave);
void ovsrec_port_remove_clause_bond_downdelay(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bond_downdelay);
void ovsrec_port_remove_clause_bond_fake_iface(struct ovsdb_idl *idl, enum ovsdb_function function, bool bond_fake_iface);
void ovsrec_port_remove_clause_bond_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *bond_mode);
void ovsrec_port_remove_clause_bond_updelay(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bond_updelay);
void ovsrec_port_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_port_remove_clause_fake_bridge(struct ovsdb_idl *idl, enum ovsdb_function function, bool fake_bridge);
void ovsrec_port_remove_clause_interfaces(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **interfaces, size_t n_interfaces);
void ovsrec_port_remove_clause_lacp(struct ovsdb_idl *idl, enum ovsdb_function function, const char *lacp);
void ovsrec_port_remove_clause_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *mac);
void ovsrec_port_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void ovsrec_port_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_port_remove_clause_qos(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *qos);
void ovsrec_port_remove_clause_rstp_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_rstp_statistics, const int64_t *value_rstp_statistics, size_t n_rstp_statistics);
void ovsrec_port_remove_clause_rstp_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_port_remove_clause_statistics(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_statistics, const int64_t *value_statistics, size_t n_statistics);
void ovsrec_port_remove_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_port_remove_clause_tag(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tag, size_t n_tag);
void ovsrec_port_remove_clause_trunks(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *trunks, size_t n_trunks);
void ovsrec_port_remove_clause_vlan_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *vlan_mode);
void ovsrec_port_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_port_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_qos_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_qos_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_qos_add_clause_queues(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_queues, struct uuid **value_queues, size_t n_queues);
void ovsrec_qos_add_clause_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *type);
void ovsrec_qos_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_qos_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_qos_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_qos_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_qos_remove_clause_queues(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_queues, struct uuid **value_queues, size_t n_queues);
void ovsrec_qos_remove_clause_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *type);
void ovsrec_qos_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_qos_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_queue_add_clause_dscp(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dscp, size_t n_dscp);
...
void ovsrec_queue_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_queue_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_queue_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_queue_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_queue_remove_clause_dscp(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dscp, size_t n_dscp);
void ovsrec_queue_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_queue_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_queue_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_queue_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_ssl_add_clause_bootstrap_ca_cert(struct ovsdb_idl *idl, enum ovsdb_function function, bool bootstrap_ca_cert);
void ovsrec_ssl_add_clause_ca_cert(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ca_cert);
void ovsrec_ssl_add_clause_certificate(struct ovsdb_idl *idl, enum ovsdb_function function, const char *certificate);
...
void ovsrec_ssl_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_ssl_add_clause_private_key(struct ovsdb_idl *idl, enum ovsdb_function function, const char *private_key);
void ovsrec_ssl_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_ssl_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_ssl_remove_clause_bootstrap_ca_cert(struct ovsdb_idl *idl, enum ovsdb_function function, bool bootstrap_ca_cert);
void ovsrec_ssl_remove_clause_ca_cert(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ca_cert);
void ovsrec_ssl_remove_clause_certificate(struct ovsdb_idl *idl, enum ovsdb_function function, const char *certificate);
void ovsrec_ssl_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_ssl_remove_clause_private_key(struct ovsdb_idl *idl, enum ovsdb_function function, const char *private_key);
void ovsrec_ssl_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_ssl_remove_clause_false(struct ovsdb_idl *idl);
...
void ovsrec_sflow_add_clause_agent(struct ovsdb_idl *idl, enum ovsdb_function function, const char *agent);
...
void ovsrec_sflow_add_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void ovsrec_sflow_add_clause_header(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *header, size_t n_header);
...
void ovsrec_sflow_add_clause_polling(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *polling, size_t n_polling);
...
void ovsrec_sflow_add_clause_sampling(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *sampling, size_t n_sampling);
...
void ovsrec_sflow_add_clause_targets(struct ovsdb_idl *idl, enum ovsdb_function function, const char **targets, size_t n_targets);
void ovsrec_sflow_add_clause_true(struct ovsdb_idl *idl);
void ovsrec_sflow_add_clause_false(struct ovsdb_idl *idl);

void ovsrec_sflow_remove_clause_agent(struct ovsdb_idl *idl, enum ovsdb_function function, const char *agent);
void ovsrec_sflow_remove_clause_external_ids(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void ovsrec_sflow_remove_clause_header(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *header, size_t n_header);
void ovsrec_sflow_remove_clause_polling(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *polling, size_t n_polling);
void ovsrec_sflow_remove_clause_sampling(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *sampling, size_t n_sampling);
void ovsrec_sflow_remove_clause_targets(struct ovsdb_idl *idl, enum ovsdb_function function, const char **targets, size_t n_targets);
void ovsrec_sflow_remove_clause_true(struct ovsdb_idl *idl);
void ovsrec_sflow_remove_clause_false(struct ovsdb_idl *idl);
