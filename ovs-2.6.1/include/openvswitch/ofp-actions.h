...
#define OFPACTS                                                         \
    ...
    OFPACT(SET_WIN_MAX,     ofpact_attr,        ofpact, "win_max")      \
    ...
    OFPACT(SET_WIN,        ofpact_attr,        ofpact, "set_win")      \
    OFPACT(SET_CMP,        ofpact_attr,        ofpact, "attr_cmp")      \
...
/* OFPACT_SET_WIN_MAX, OFPACT_SET_MOV_MAX, OFPACT_SET_MIN, OFPACT_SET_MAX, OFPACT_SET_WIN, OFPACT_SET_CMP.
 *
 * Used for OFPAT10_SET_WIN_MAX, OFPAT10_SET_MOV_MAX, OFPAT10_SET_MIN, OFPAT10_SET_MAX, OFPAT10_SET_WIN, OFPAT10_SET_CMP. */
struct ofpact_attr {
    struct ofpact ofpact;
