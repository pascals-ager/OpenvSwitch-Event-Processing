...
vteprec_acl_update_acl_entries_addvalue(const struct vteprec_acl *row, const struct vteprec_acl_entry *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_columns[VTEPREC_ACL_COL_ACL_ENTRIES],
                                    datum);
}
...
vteprec_acl_update_acl_fault_status_addvalue(const struct vteprec_acl *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_columns[VTEPREC_ACL_COL_ACL_FAULT_STATUS],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_add_clause_acl_entries(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **acl_entries, size_t n_acl_entries)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL],
                          function,
                          &vteprec_acl_columns[VTEPREC_ACL_COL_ACL_ENTRIES],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_add_clause_acl_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acl_fault_status, size_t n_acl_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_add_clause_acl_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *acl_name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL],
                          function,
                          &vteprec_acl_columns[VTEPREC_ACL_COL_ACL_NAME],
                          &datum);
}
void
vteprec_acl_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_acl_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_remove_clause_acl_entries(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **acl_entries, size_t n_acl_entries)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL],
                          function,
                          &vteprec_acl_columns[VTEPREC_ACL_COL_ACL_ENTRIES],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_remove_clause_acl_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acl_fault_status, size_t n_acl_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_remove_clause_acl_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *acl_name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_acl_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_acl_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL], OVSDB_F_TRUE, NULL, &datum);
}
...
vteprec_acl_entry_update_acle_fault_status_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_ACLE_FAULT_STATUS],
                                    datum);
}
...
vteprec_acl_entry_update_dest_ip_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_DEST_IP],
                                    datum);
}
...
vteprec_acl_entry_update_dest_mac_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_DEST_MAC],
                                    datum);
}
...
vteprec_acl_entry_update_dest_mask_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_DEST_MASK],
                                    datum);
}
...
vteprec_acl_entry_update_dest_port_max_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_DEST_PORT_MAX],
                                    datum);
}
...
vteprec_acl_entry_update_dest_port_min_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_DEST_PORT_MIN],
                                    datum);
}
...
vteprec_acl_entry_update_ethertype_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_ETHERTYPE],
                                    datum);
}
...
vteprec_acl_entry_update_icmp_code_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_ICMP_CODE],
                                    datum);
}
...
vteprec_acl_entry_update_icmp_type_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_ICMP_TYPE],
                                    datum);
}
...
vteprec_acl_entry_update_protocol_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_PROTOCOL],
                                    datum);
}
...
vteprec_acl_entry_update_source_ip_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_SOURCE_IP],
                                    datum);
}
...
vteprec_acl_entry_update_source_mac_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_SOURCE_MAC],
                                    datum);
}
...
vteprec_acl_entry_update_source_mask_addvalue(const struct vteprec_acl_entry *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_SOURCE_MASK],
                                    datum);
}
...
vteprec_acl_entry_update_source_port_max_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_SOURCE_PORT_MAX],
                                    datum);
}
...
vteprec_acl_entry_update_source_port_min_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_SOURCE_PORT_MIN],
                                    datum);
}
...
vteprec_acl_entry_update_tcp_flags_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_TCP_FLAGS],
                                    datum);
}
...
vteprec_acl_entry_update_tcp_flags_mask_addvalue(const struct vteprec_acl_entry *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_TCP_FLAGS_MASK],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_acle_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acle_fault_status, size_t n_acle_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_STRING, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY],
                          function,
                          &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_ACLE_FAULT_STATUS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_action(struct ovsdb_idl *idl, enum ovsdb_function function, const char *action)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY],
                          function,
                          &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_ACTION],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_dest_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_ip)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_dest_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_dest_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mask)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_dest_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_max, size_t n_dest_port_max)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_dest_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_min, size_t n_dest_port_min)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_direction(struct ovsdb_idl *idl, enum ovsdb_function function, const char *direction)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY],
                          function,
                          &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_DIRECTION],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_ethertype(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ethertype)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_icmp_code(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_code, size_t n_icmp_code)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_icmp_type(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_type, size_t n_icmp_type)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_protocol(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *protocol, size_t n_protocol)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_sequence(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t sequence)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY],
                          function,
                          &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_SEQUENCE],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_source_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_ip)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_source_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_source_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mask)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_source_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_max, size_t n_source_port_max)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_source_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_min, size_t n_source_port_min)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_tcp_flags(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags, size_t n_tcp_flags)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_add_clause_tcp_flags_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags_mask, size_t n_tcp_flags_mask)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_acl_entry_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_acl_entry_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_acle_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acle_fault_status, size_t n_acle_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_STRING, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY],
                          function,
                          &vteprec_acl_entry_columns[VTEPREC_ACL_ENTRY_COL_ACLE_FAULT_STATUS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_action(struct ovsdb_idl *idl, enum ovsdb_function function, const char *action)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_dest_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_ip)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_dest_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_dest_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mask)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_dest_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_max, size_t n_dest_port_max)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_dest_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_min, size_t n_dest_port_min)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_direction(struct ovsdb_idl *idl, enum ovsdb_function function, const char *direction)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_ethertype(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ethertype)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_icmp_code(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_code, size_t n_icmp_code)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_icmp_type(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_type, size_t n_icmp_type)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_protocol(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *protocol, size_t n_protocol)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_sequence(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t sequence)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_source_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_ip)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_source_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_source_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mask)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_source_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_max, size_t n_source_port_max)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_source_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_min, size_t n_source_port_min)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_tcp_flags(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags, size_t n_tcp_flags)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_acl_entry_remove_clause_tcp_flags_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags_mask, size_t n_tcp_flags_mask)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_acl_entry_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_acl_entry_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ACL_ENTRY], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_local_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.uuid = *locator;
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_LOCAL],
                          function,
                          &vteprec_arp_sources_local_columns[VTEPREC_ARP_SOURCES_LOCAL_COL_LOCATOR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_local_add_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_LOCAL],
                          function,
                          &vteprec_arp_sources_local_columns[VTEPREC_ARP_SOURCES_LOCAL_COL_SRC_MAC],
                          &datum);
}
void
vteprec_arp_sources_local_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_LOCAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_arp_sources_local_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_LOCAL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_local_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.uuid = *locator;
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_LOCAL],
                          function,
                          &vteprec_arp_sources_local_columns[VTEPREC_ARP_SOURCES_LOCAL_COL_LOCATOR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_local_remove_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_arp_sources_local_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_LOCAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_arp_sources_local_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_LOCAL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_remote_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.uuid = *locator;
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_REMOTE],
                          function,
                          &vteprec_arp_sources_remote_columns[VTEPREC_ARP_SOURCES_REMOTE_COL_LOCATOR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_remote_add_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_REMOTE],
                          function,
                          &vteprec_arp_sources_remote_columns[VTEPREC_ARP_SOURCES_REMOTE_COL_SRC_MAC],
                          &datum);
}
void
vteprec_arp_sources_remote_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_REMOTE], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_arp_sources_remote_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_REMOTE], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_remote_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.uuid = *locator;
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_REMOTE],
                          function,
                          &vteprec_arp_sources_remote_columns[VTEPREC_ARP_SOURCES_REMOTE_COL_LOCATOR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_arp_sources_remote_remove_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_arp_sources_remote_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_REMOTE], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_arp_sources_remote_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_ARP_SOURCES_REMOTE], OVSDB_F_TRUE, NULL, &datum);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &vteprec_global_columns[VTEPREC_GLOBAL_COL_OTHER_CONFIG]);
}
...
vteprec_global_update_managers_addvalue(const struct vteprec_global *row, const struct vteprec_manager *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_global_columns[VTEPREC_GLOBAL_COL_MANAGERS],
                                    datum);
}
...
vteprec_global_update_switches_addvalue(const struct vteprec_global *row, const struct vteprec_physical_switch *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_global_columns[VTEPREC_GLOBAL_COL_SWITCHES],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_global_add_clause_managers(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **managers, size_t n_managers)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_GLOBAL],
                          function,
                          &vteprec_global_columns[VTEPREC_GLOBAL_COL_MANAGERS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_global_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_global_add_clause_switches(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **switches, size_t n_switches)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_global_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_GLOBAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_global_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_GLOBAL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_global_remove_clause_managers(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **managers, size_t n_managers)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_GLOBAL],
                          function,
                          &vteprec_global_columns[VTEPREC_GLOBAL_COL_MANAGERS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_global_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_global_remove_clause_switches(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **switches, size_t n_switches)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_global_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_GLOBAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_global_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_GLOBAL], OVSDB_F_TRUE, NULL, &datum);
}
...
vteprec_global_columns_init(void)
{
    ...
    /* Initialize vteprec_global_col_other_config. */
    c = &vteprec_global_col_other_config;
    c->name = "other_config";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ...
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = vteprec_global_parse_other_config;
    c->unparse = vteprec_global_unparse_other_config;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_add_clause_bytes_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_from_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.integer = bytes_from_local;
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS],
                          function,
                          &vteprec_logical_binding_stats_columns[VTEPREC_LOGICAL_BINDING_STATS_COL_BYTES_FROM_LOCAL],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_add_clause_bytes_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_to_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS],
                          function,
                          &vteprec_logical_binding_stats_columns[VTEPREC_LOGICAL_BINDING_STATS_COL_BYTES_TO_LOCAL],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_add_clause_packets_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_from_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_add_clause_packets_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_to_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS],
                          function,
                          &vteprec_logical_binding_stats_columns[VTEPREC_LOGICAL_BINDING_STATS_COL_PACKETS_TO_LOCAL],
                          &datum);
}
void
vteprec_logical_binding_stats_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_logical_binding_stats_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_remove_clause_bytes_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_from_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.integer = bytes_from_local;
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS],
                          function,
                          &vteprec_logical_binding_stats_columns[VTEPREC_LOGICAL_BINDING_STATS_COL_BYTES_FROM_LOCAL],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_remove_clause_bytes_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_to_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_remove_clause_packets_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_from_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_binding_stats_remove_clause_packets_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_to_local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_logical_binding_stats_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_logical_binding_stats_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_BINDING_STATS], OVSDB_F_TRUE, NULL, &datum);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &vteprec_logical_router_columns[VTEPREC_LOGICAL_ROUTER_COL_OTHER_CONFIG]);
}
...
vteprec_logical_router_update_LR_fault_status_addvalue(const struct vteprec_logical_router *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_logical_router_columns[VTEPREC_LOGICAL_ROUTER_COL_LR_FAULT_STATUS],
                                    datum);
}
...
vteprec_logical_router_update_acl_binding_setkey(const struct vteprec_logical_router *row, const char *new_key, const struct vteprec_acl *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_map(&row->header_,
                                    &vteprec_logical_router_columns[VTEPREC_LOGICAL_ROUTER_COL_ACL_BINDING],
                                    datum);
}
...
vteprec_logical_router_update_switch_binding_setkey(const struct vteprec_logical_router *row, const char *new_key, const struct vteprec_logical_switch *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_map(&row->header_,
                                    &vteprec_logical_router_columns[VTEPREC_LOGICAL_ROUTER_COL_SWITCH_BINDING],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_add_clause_LR_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **LR_fault_status, size_t n_LR_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_STRING, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_ROUTER],
                          function,
                          &vteprec_logical_router_columns[VTEPREC_LOGICAL_ROUTER_COL_LR_FAULT_STATUS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_add_clause_acl_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_acl_binding, struct uuid **value_acl_binding, size_t n_acl_binding)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_ROUTER],
                          function,
                          &vteprec_logical_router_columns[VTEPREC_LOGICAL_ROUTER_COL_NAME],
                          &datum);
}
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_logical_router_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'static_routes' and everything in it. */
void
vteprec_logical_router_add_clause_static_routes(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *static_routes)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_add_clause_switch_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_switch_binding, struct uuid **value_switch_binding, size_t n_switch_binding)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_logical_router_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_ROUTER], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_logical_router_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_ROUTER], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_remove_clause_LR_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **LR_fault_status, size_t n_LR_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_STRING, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_ROUTER],
                          function,
                          &vteprec_logical_router_columns[VTEPREC_LOGICAL_ROUTER_COL_LR_FAULT_STATUS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_remove_clause_acl_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_acl_binding, struct uuid **value_acl_binding, size_t n_acl_binding)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_logical_router_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'static_routes' and everything in it. */
void
vteprec_logical_router_remove_clause_static_routes(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *static_routes)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_router_remove_clause_switch_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_switch_binding, struct uuid **value_switch_binding, size_t n_switch_binding)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_logical_router_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_ROUTER], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_logical_router_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_ROUTER], OVSDB_F_TRUE, NULL, &datum);
}
...
vteprec_logical_router_columns_init(void)
{
    ...
    /* Initialize vteprec_logical_router_col_other_config. */
    c = &vteprec_logical_router_col_other_config;
    c->name = "other_config";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_STRING);
    ...
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = vteprec_logical_router_parse_other_config;
    c->unparse = vteprec_logical_router_unparse_other_config;
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_OTHER_CONFIG]);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_REPLICATION_MODE]);
}
...
vteprec_logical_switch_set_replication_mode(const struct vteprec_logical_switch *row, const char *replication_mode)
{
    ...
    datum.values = NULL;
    ovsdb_idl_txn_write_clone(&row->header_, &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_REPLICATION_MODE], &datum);
}
...
vteprec_logical_switch_update_replication_mode_addvalue(const struct vteprec_logical_switch *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_REPLICATION_MODE],
                                    datum);
}
...
vteprec_logical_switch_update_tunnel_key_addvalue(const struct vteprec_logical_switch *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_TUNNEL_KEY],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, description);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_SWITCH],
                          function,
                          &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_DESCRIPTION],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_SWITCH],
                          function,
                          &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_NAME],
                          &datum);
}
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_logical_switch_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_add_clause_replication_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *replication_mode)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_add_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_logical_switch_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_SWITCH], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_logical_switch_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_SWITCH], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, description);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_SWITCH],
                          function,
                          &vteprec_logical_switch_columns[VTEPREC_LOGICAL_SWITCH_COL_DESCRIPTION],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_logical_switch_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_remove_clause_replication_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *replication_mode)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_logical_switch_remove_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_logical_switch_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_SWITCH], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_logical_switch_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_LOGICAL_SWITCH], OVSDB_F_TRUE, NULL, &datum);
}
...
vteprec_logical_switch_columns_init(void)
{
    ...
    /* Initialize vteprec_logical_switch_col_other_config. */
    c = &vteprec_logical_switch_col_other_config;
    c->name = "other_config";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_STRING);
    ...
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = vteprec_logical_switch_parse_other_config;
    c->unparse = vteprec_logical_switch_unparse_other_config;

    /* Initialize vteprec_logical_switch_col_replication_mode. */
    c = &vteprec_logical_switch_col_replication_mode;
    c->name = "replication_mode";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.enum_ = xmalloc(sizeof *c->type.key.enum_);
    c->type.key.enum_->n = 2;
    c->type.key.enum_->keys = xmalloc(2 * sizeof *c->type.key.enum_->keys);
    c->type.key.enum_->keys[0].string = xstrdup("service_node");
    c->type.key.enum_->keys[1].string = xstrdup("source_node");
    c->type.key.enum_->values = NULL;
    ovsdb_datum_sort_assert(c->type.key.enum_, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_VOID);
    ...
    c->type.n_max = 1;
    c->mutable = true;
    c->parse = vteprec_logical_switch_parse_replication_mode;
    c->unparse = vteprec_logical_switch_unparse_replication_mode;
...
vteprec_manager_update_inactivity_probe_addvalue(const struct vteprec_manager *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_manager_columns[VTEPREC_MANAGER_COL_INACTIVITY_PROBE],
                                    datum);
}
...
vteprec_manager_update_max_backoff_addvalue(const struct vteprec_manager *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_manager_columns[VTEPREC_MANAGER_COL_MAX_BACKOFF],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_add_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER],
                          function,
                          &vteprec_manager_columns[VTEPREC_MANAGER_COL_INACTIVITY_PROBE],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_add_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER],
                          function,
                          &vteprec_manager_columns[VTEPREC_MANAGER_COL_IS_CONNECTED],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_add_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_manager_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'status' and everything in it. */
void
vteprec_manager_add_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *status)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_add_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER],
                          function,
                          &vteprec_manager_columns[VTEPREC_MANAGER_COL_TARGET],
                          &datum);
}
void
vteprec_manager_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_manager_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_remove_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER],
                          function,
                          &vteprec_manager_columns[VTEPREC_MANAGER_COL_INACTIVITY_PROBE],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_remove_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_remove_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_manager_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'status' and everything in it. */
void
vteprec_manager_remove_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *status)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_manager_remove_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_manager_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_manager_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MANAGER], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL],
                          function,
                          &vteprec_mcast_macs_local_columns[VTEPREC_MCAST_MACS_LOCAL_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL],
                          function,
                          &vteprec_mcast_macs_local_columns[VTEPREC_MCAST_MACS_LOCAL_COL_IPADDR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_add_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL],
                          function,
                          &vteprec_mcast_macs_local_columns[VTEPREC_MCAST_MACS_LOCAL_COL_LOCATOR_SET],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL],
                          function,
                          &vteprec_mcast_macs_local_columns[VTEPREC_MCAST_MACS_LOCAL_COL_LOGICAL_SWITCH],
                          &datum);
}
void
vteprec_mcast_macs_local_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_mcast_macs_local_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL],
                          function,
                          &vteprec_mcast_macs_local_columns[VTEPREC_MCAST_MACS_LOCAL_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_remove_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_local_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_mcast_macs_local_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_mcast_macs_local_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_LOCAL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE],
                          function,
                          &vteprec_mcast_macs_remote_columns[VTEPREC_MCAST_MACS_REMOTE_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE],
                          function,
                          &vteprec_mcast_macs_remote_columns[VTEPREC_MCAST_MACS_REMOTE_COL_IPADDR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_add_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE],
                          function,
                          &vteprec_mcast_macs_remote_columns[VTEPREC_MCAST_MACS_REMOTE_COL_LOCATOR_SET],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE],
                          function,
                          &vteprec_mcast_macs_remote_columns[VTEPREC_MCAST_MACS_REMOTE_COL_LOGICAL_SWITCH],
                          &datum);
}
void
vteprec_mcast_macs_remote_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_mcast_macs_remote_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE],
                          function,
                          &vteprec_mcast_macs_remote_columns[VTEPREC_MCAST_MACS_REMOTE_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_remove_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_mcast_macs_remote_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_mcast_macs_remote_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_mcast_macs_remote_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_MCAST_MACS_REMOTE], OVSDB_F_TRUE, NULL, &datum);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &vteprec_physical_locator_columns[VTEPREC_PHYSICAL_LOCATOR_COL_TUNNEL_KEY]);
}
...
vteprec_physical_locator_set_tunnel_key(const struct vteprec_physical_locator *row, const int64_t *tunnel_key, size_t n_tunnel_key)
{
    ...
    datum.values = NULL;
    ovsdb_idl_txn_write_clone(&row->header_, &vteprec_physical_locator_columns[VTEPREC_PHYSICAL_LOCATOR_COL_TUNNEL_KEY], &datum);
}
...
vteprec_physical_locator_update_tunnel_key_addvalue(const struct vteprec_physical_locator *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_locator_columns[VTEPREC_PHYSICAL_LOCATOR_COL_TUNNEL_KEY],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_add_clause_dst_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dst_ip)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, dst_ip);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR],
                          function,
                          &vteprec_physical_locator_columns[VTEPREC_PHYSICAL_LOCATOR_COL_DST_IP],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_add_clause_encapsulation_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *encapsulation_type)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR],
                          function,
                          &vteprec_physical_locator_columns[VTEPREC_PHYSICAL_LOCATOR_COL_ENCAPSULATION_TYPE],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_add_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_physical_locator_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_locator_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_remove_clause_dst_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dst_ip)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, dst_ip);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR],
                          function,
                          &vteprec_physical_locator_columns[VTEPREC_PHYSICAL_LOCATOR_COL_DST_IP],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_remove_clause_encapsulation_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *encapsulation_type)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_remove_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_physical_locator_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_locator_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR], OVSDB_F_TRUE, NULL, &datum);
}
...
vteprec_physical_locator_columns_init(void)
{
    ...
    /* Initialize vteprec_physical_locator_col_tunnel_key. */
    c = &vteprec_physical_locator_col_tunnel_key;
    c->name = "tunnel_key";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_INTEGER);
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_VOID);
    c->type.n_min = 0;
    c->type.n_max = 1;
    c->mutable = true;
    c->parse = vteprec_physical_locator_parse_tunnel_key;
    c->unparse = vteprec_physical_locator_unparse_tunnel_key;
}

...
vteprec_physical_locator_set_update_locators_addvalue(const struct vteprec_physical_locator_set *row, const struct vteprec_physical_locator *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_locator_set_columns[VTEPREC_PHYSICAL_LOCATOR_SET_COL_LOCATORS],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_set_add_clause_locators(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **locators, size_t n_locators)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR_SET],
                          function,
                          &vteprec_physical_locator_set_columns[VTEPREC_PHYSICAL_LOCATOR_SET_COL_LOCATORS],
                          &datum);
    free(datum.keys);
...
void
vteprec_physical_locator_set_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR_SET], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_locator_set_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR_SET], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_locator_set_remove_clause_locators(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **locators, size_t n_locators)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR_SET],
                          function,
                          &vteprec_physical_locator_set_columns[VTEPREC_PHYSICAL_LOCATOR_SET_COL_LOCATORS],
                          &datum);
    free(datum.keys);
...
void
vteprec_physical_locator_set_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR_SET], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_locator_set_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_LOCATOR_SET], OVSDB_F_TRUE, NULL, &datum);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_OTHER_CONFIG]);
}
...
vteprec_physical_port_update_acl_bindings_setkey(const struct vteprec_physical_port *row, int64_t new_key, const struct vteprec_acl *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_map(&row->header_,
                                    &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_ACL_BINDINGS],
                                    datum);
}
...
vteprec_physical_port_update_port_fault_status_addvalue(const struct vteprec_physical_port *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_PORT_FAULT_STATUS],
                                    datum);
}
...
vteprec_physical_port_update_vlan_bindings_setkey(const struct vteprec_physical_port *row, int64_t new_key, const struct vteprec_logical_switch *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_map(&row->header_,
                                    &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_VLAN_BINDINGS],
                                    datum);
}
...
vteprec_physical_port_update_vlan_stats_setkey(const struct vteprec_physical_port *row, int64_t new_key, const struct vteprec_logical_binding_stats *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_map(&row->header_,
                                    &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_VLAN_STATS],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_add_clause_acl_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_acl_bindings, struct uuid **value_acl_bindings, size_t n_acl_bindings)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_INTEGER, OVSDB_TYPE_UUID);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_PORT],
                          function,
                          &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_ACL_BINDINGS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_PORT],
                          function,
                          &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_DESCRIPTION],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_physical_port_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_add_clause_port_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **port_fault_status, size_t n_port_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_add_clause_vlan_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_bindings, struct uuid **value_vlan_bindings, size_t n_vlan_bindings)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_add_clause_vlan_stats(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_stats, struct uuid **value_vlan_stats, size_t n_vlan_stats)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_physical_port_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_PORT], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_port_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_PORT], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_remove_clause_acl_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_acl_bindings, struct uuid **value_acl_bindings, size_t n_acl_bindings)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_INTEGER, OVSDB_TYPE_UUID);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_PORT],
                          function,
                          &vteprec_physical_port_columns[VTEPREC_PHYSICAL_PORT_COL_ACL_BINDINGS],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_physical_port_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_remove_clause_port_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **port_fault_status, size_t n_port_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_remove_clause_vlan_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_bindings, struct uuid **value_vlan_bindings, size_t n_vlan_bindings)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_port_remove_clause_vlan_stats(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_stats, struct uuid **value_vlan_stats, size_t n_vlan_stats)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_physical_port_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_PORT], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_port_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_PORT], OVSDB_F_TRUE, NULL, &datum);
}
...
vteprec_physical_port_columns_init(void)
{
    ...
    /* Initialize vteprec_physical_port_col_other_config. */
    c = &vteprec_physical_port_col_other_config;
    c->name = "other_config";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_STRING);
    ...
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = vteprec_physical_port_parse_other_config;
    c->unparse = vteprec_physical_port_unparse_other_config;
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_OTHER_CONFIG]);
}
...
vteprec_physical_switch_update_management_ips_addvalue(const struct vteprec_physical_switch *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_MANAGEMENT_IPS],
                                    datum);
}
...
vteprec_physical_switch_update_ports_addvalue(const struct vteprec_physical_switch *row, const struct vteprec_physical_port *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_PORTS],
                                    datum);
}
...
vteprec_physical_switch_update_switch_fault_status_addvalue(const struct vteprec_physical_switch *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_SWITCH_FAULT_STATUS],
                                    datum);
}
...
vteprec_physical_switch_update_tunnel_ips_addvalue(const struct vteprec_physical_switch *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_TUNNEL_IPS],
                                    datum);
}
...
vteprec_physical_switch_update_tunnels_addvalue(const struct vteprec_physical_switch *row, const struct vteprec_tunnel *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_TUNNELS],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, description);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_SWITCH],
                          function,
                          &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_DESCRIPTION],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_add_clause_management_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **management_ips, size_t n_management_ips)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_SWITCH],
                          function,
                          &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_NAME],
                          &datum);
}
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_physical_switch_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_add_clause_ports(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ports, size_t n_ports)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_add_clause_switch_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **switch_fault_status, size_t n_switch_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_add_clause_tunnel_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **tunnel_ips, size_t n_tunnel_ips)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_add_clause_tunnels(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **tunnels, size_t n_tunnels)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_physical_switch_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_SWITCH], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_switch_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_SWITCH], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, description);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_SWITCH],
                          function,
                          &vteprec_physical_switch_columns[VTEPREC_PHYSICAL_SWITCH_COL_DESCRIPTION],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_remove_clause_management_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **management_ips, size_t n_management_ips)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'other_config' and everything in it. */
void
vteprec_physical_switch_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *other_config)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_remove_clause_ports(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ports, size_t n_ports)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_remove_clause_switch_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **switch_fault_status, size_t n_switch_fault_status)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_remove_clause_tunnel_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **tunnel_ips, size_t n_tunnel_ips)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_physical_switch_remove_clause_tunnels(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **tunnels, size_t n_tunnels)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
vteprec_physical_switch_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_SWITCH], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_physical_switch_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_PHYSICAL_SWITCH], OVSDB_F_TRUE, NULL, &datum);
}
...
vteprec_physical_switch_columns_init(void)
{
    ...
    /* Initialize vteprec_physical_switch_col_other_config. */
    c = &vteprec_physical_switch_col_other_config;
    c->name = "other_config";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_STRING);
    ...
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = vteprec_physical_switch_parse_other_config;
    c->unparse = vteprec_physical_switch_unparse_other_config;
 ...
 * The caller retains ownership of 'bfd_config_local' and everything in it. */
void
vteprec_tunnel_add_clause_bfd_config_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_config_local)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'bfd_config_remote' and everything in it. */
void
vteprec_tunnel_add_clause_bfd_config_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_config_remote)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'bfd_params' and everything in it. */
void
vteprec_tunnel_add_clause_bfd_params(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_params)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'bfd_status' and everything in it. */
void
vteprec_tunnel_add_clause_bfd_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_status)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_tunnel_add_clause_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.uuid = *local;
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_TUNNEL],
                          function,
                          &vteprec_tunnel_columns[VTEPREC_TUNNEL_COL_LOCAL],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_tunnel_add_clause_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *remote)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_TUNNEL],
                          function,
                          &vteprec_tunnel_columns[VTEPREC_TUNNEL_COL_REMOTE],
                          &datum);
}
void
vteprec_tunnel_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_TUNNEL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_tunnel_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_TUNNEL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of 'bfd_config_local' and everything in it. */
void
vteprec_tunnel_remove_clause_bfd_config_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_config_local)
{
    struct ovsdb_datum datum;
    ...
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_TUNNEL],
                                      function,
                                      &vteprec_tunnel_columns[VTEPREC_TUNNEL_COL_BFD_CONFIG_LOCAL],
                                      &datum);
 ...
 * The caller retains ownership of 'bfd_config_remote' and everything in it. */
void
vteprec_tunnel_remove_clause_bfd_config_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_config_remote)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'bfd_params' and everything in it. */
void
vteprec_tunnel_remove_clause_bfd_params(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_params)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of 'bfd_status' and everything in it. */
void
vteprec_tunnel_remove_clause_bfd_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *bfd_status)
{
    struct ovsdb_datum datum;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_tunnel_remove_clause_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *local)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_tunnel_remove_clause_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *remote)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_tunnel_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_TUNNEL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_tunnel_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_TUNNEL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL],
                          function,
                          &vteprec_ucast_macs_local_columns[VTEPREC_UCAST_MACS_LOCAL_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL],
                          function,
                          &vteprec_ucast_macs_local_columns[VTEPREC_UCAST_MACS_LOCAL_COL_IPADDR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL],
                          function,
                          &vteprec_ucast_macs_local_columns[VTEPREC_UCAST_MACS_LOCAL_COL_LOCATOR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL],
                          function,
                          &vteprec_ucast_macs_local_columns[VTEPREC_UCAST_MACS_LOCAL_COL_LOGICAL_SWITCH],
                          &datum);
}
void
vteprec_ucast_macs_local_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_ucast_macs_local_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL],
                          function,
                          &vteprec_ucast_macs_local_columns[VTEPREC_UCAST_MACS_LOCAL_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_local_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_ucast_macs_local_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_ucast_macs_local_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_LOCAL], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE],
                          function,
                          &vteprec_ucast_macs_remote_columns[VTEPREC_UCAST_MACS_REMOTE_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE],
                          function,
                          &vteprec_ucast_macs_remote_columns[VTEPREC_UCAST_MACS_REMOTE_COL_IPADDR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE],
                          function,
                          &vteprec_ucast_macs_remote_columns[VTEPREC_UCAST_MACS_REMOTE_COL_LOCATOR],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE],
                          function,
                          &vteprec_ucast_macs_remote_columns[VTEPREC_UCAST_MACS_REMOTE_COL_LOGICAL_SWITCH],
                          &datum);
}
void
vteprec_ucast_macs_remote_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_ucast_macs_remote_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, MAC);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE],
                          function,
                          &vteprec_ucast_macs_remote_columns[VTEPREC_UCAST_MACS_REMOTE_COL_MAC],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
vteprec_ucast_macs_remote_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
vteprec_ucast_macs_remote_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE], OVSDB_F_FALSE, NULL, &datum);
}
void
vteprec_ucast_macs_remote_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &vteprec_table_classes[VTEPREC_TABLE_UCAST_MACS_REMOTE], OVSDB_F_TRUE, NULL, &datum);
}
