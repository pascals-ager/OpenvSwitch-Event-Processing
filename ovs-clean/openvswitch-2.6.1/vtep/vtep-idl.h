...
void vteprec_acl_add_clause_acl_entries(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **acl_entries, size_t n_acl_entries);
...
void vteprec_acl_add_clause_acl_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acl_fault_status, size_t n_acl_fault_status);
void vteprec_acl_add_clause_acl_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *acl_name);
void vteprec_acl_add_clause_true(struct ovsdb_idl *idl);
void vteprec_acl_add_clause_false(struct ovsdb_idl *idl);

void vteprec_acl_remove_clause_acl_entries(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **acl_entries, size_t n_acl_entries);
void vteprec_acl_remove_clause_acl_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acl_fault_status, size_t n_acl_fault_status);
void vteprec_acl_remove_clause_acl_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *acl_name);
void vteprec_acl_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_acl_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_acl_entry_add_clause_acle_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acle_fault_status, size_t n_acle_fault_status);
void vteprec_acl_entry_add_clause_action(struct ovsdb_idl *idl, enum ovsdb_function function, const char *action);
...
void vteprec_acl_entry_add_clause_dest_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_ip);
...
void vteprec_acl_entry_add_clause_dest_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mac);
...
void vteprec_acl_entry_add_clause_dest_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mask);
...
void vteprec_acl_entry_add_clause_dest_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_max, size_t n_dest_port_max);
...
void vteprec_acl_entry_add_clause_dest_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_min, size_t n_dest_port_min);
void vteprec_acl_entry_add_clause_direction(struct ovsdb_idl *idl, enum ovsdb_function function, const char *direction);
...
void vteprec_acl_entry_add_clause_ethertype(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ethertype);
...
void vteprec_acl_entry_add_clause_icmp_code(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_code, size_t n_icmp_code);
...
void vteprec_acl_entry_add_clause_icmp_type(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_type, size_t n_icmp_type);
...
void vteprec_acl_entry_add_clause_protocol(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *protocol, size_t n_protocol);
void vteprec_acl_entry_add_clause_sequence(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t sequence);
...
void vteprec_acl_entry_add_clause_source_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_ip);
...
void vteprec_acl_entry_add_clause_source_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mac);
...
void vteprec_acl_entry_add_clause_source_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mask);
...
void vteprec_acl_entry_add_clause_source_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_max, size_t n_source_port_max);
...
void vteprec_acl_entry_add_clause_source_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_min, size_t n_source_port_min);
...
void vteprec_acl_entry_add_clause_tcp_flags(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags, size_t n_tcp_flags);
...
void vteprec_acl_entry_add_clause_tcp_flags_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags_mask, size_t n_tcp_flags_mask);
void vteprec_acl_entry_add_clause_true(struct ovsdb_idl *idl);
void vteprec_acl_entry_add_clause_false(struct ovsdb_idl *idl);

void vteprec_acl_entry_remove_clause_acle_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **acle_fault_status, size_t n_acle_fault_status);
void vteprec_acl_entry_remove_clause_action(struct ovsdb_idl *idl, enum ovsdb_function function, const char *action);
void vteprec_acl_entry_remove_clause_dest_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_ip);
void vteprec_acl_entry_remove_clause_dest_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mac);
void vteprec_acl_entry_remove_clause_dest_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dest_mask);
void vteprec_acl_entry_remove_clause_dest_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_max, size_t n_dest_port_max);
void vteprec_acl_entry_remove_clause_dest_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *dest_port_min, size_t n_dest_port_min);
void vteprec_acl_entry_remove_clause_direction(struct ovsdb_idl *idl, enum ovsdb_function function, const char *direction);
void vteprec_acl_entry_remove_clause_ethertype(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ethertype);
void vteprec_acl_entry_remove_clause_icmp_code(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_code, size_t n_icmp_code);
void vteprec_acl_entry_remove_clause_icmp_type(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *icmp_type, size_t n_icmp_type);
void vteprec_acl_entry_remove_clause_protocol(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *protocol, size_t n_protocol);
void vteprec_acl_entry_remove_clause_sequence(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t sequence);
void vteprec_acl_entry_remove_clause_source_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_ip);
void vteprec_acl_entry_remove_clause_source_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mac);
void vteprec_acl_entry_remove_clause_source_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const char *source_mask);
void vteprec_acl_entry_remove_clause_source_port_max(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_max, size_t n_source_port_max);
void vteprec_acl_entry_remove_clause_source_port_min(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *source_port_min, size_t n_source_port_min);
void vteprec_acl_entry_remove_clause_tcp_flags(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags, size_t n_tcp_flags);
void vteprec_acl_entry_remove_clause_tcp_flags_mask(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tcp_flags_mask, size_t n_tcp_flags_mask);
void vteprec_acl_entry_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_acl_entry_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_arp_sources_local_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_arp_sources_local_add_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac);
void vteprec_arp_sources_local_add_clause_true(struct ovsdb_idl *idl);
void vteprec_arp_sources_local_add_clause_false(struct ovsdb_idl *idl);

void vteprec_arp_sources_local_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_arp_sources_local_remove_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac);
void vteprec_arp_sources_local_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_arp_sources_local_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_arp_sources_remote_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_arp_sources_remote_add_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac);
void vteprec_arp_sources_remote_add_clause_true(struct ovsdb_idl *idl);
void vteprec_arp_sources_remote_add_clause_false(struct ovsdb_idl *idl);

void vteprec_arp_sources_remote_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_arp_sources_remote_remove_clause_src_mac(struct ovsdb_idl *idl, enum ovsdb_function function, const char *src_mac);
void vteprec_arp_sources_remote_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_arp_sources_remote_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_global_add_clause_managers(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **managers, size_t n_managers);
...
void vteprec_global_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_global_add_clause_switches(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **switches, size_t n_switches);
void vteprec_global_add_clause_true(struct ovsdb_idl *idl);
void vteprec_global_add_clause_false(struct ovsdb_idl *idl);

void vteprec_global_remove_clause_managers(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **managers, size_t n_managers);
void vteprec_global_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_global_remove_clause_switches(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **switches, size_t n_switches);
void vteprec_global_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_global_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_logical_binding_stats_add_clause_bytes_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_from_local);
void vteprec_logical_binding_stats_add_clause_bytes_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_to_local);
void vteprec_logical_binding_stats_add_clause_packets_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_from_local);
void vteprec_logical_binding_stats_add_clause_packets_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_to_local);
void vteprec_logical_binding_stats_add_clause_true(struct ovsdb_idl *idl);
void vteprec_logical_binding_stats_add_clause_false(struct ovsdb_idl *idl);

void vteprec_logical_binding_stats_remove_clause_bytes_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_from_local);
void vteprec_logical_binding_stats_remove_clause_bytes_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t bytes_to_local);
void vteprec_logical_binding_stats_remove_clause_packets_from_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_from_local);
void vteprec_logical_binding_stats_remove_clause_packets_to_local(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t packets_to_local);
void vteprec_logical_binding_stats_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_logical_binding_stats_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_logical_router_add_clause_LR_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **LR_fault_status, size_t n_LR_fault_status);
...
void vteprec_logical_router_add_clause_acl_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_acl_binding, struct uuid **value_acl_binding, size_t n_acl_binding);
void vteprec_logical_router_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
void vteprec_logical_router_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void vteprec_logical_router_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_logical_router_add_clause_static_routes(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_logical_router_add_clause_switch_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_switch_binding, struct uuid **value_switch_binding, size_t n_switch_binding);
void vteprec_logical_router_add_clause_true(struct ovsdb_idl *idl);
void vteprec_logical_router_add_clause_false(struct ovsdb_idl *idl);

void vteprec_logical_router_remove_clause_LR_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **LR_fault_status, size_t n_LR_fault_status);
void vteprec_logical_router_remove_clause_acl_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_acl_binding, struct uuid **value_acl_binding, size_t n_acl_binding);
void vteprec_logical_router_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
void vteprec_logical_router_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void vteprec_logical_router_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_logical_router_remove_clause_static_routes(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_logical_router_remove_clause_switch_binding(struct ovsdb_idl *idl, enum ovsdb_function function, const char **key_switch_binding, struct uuid **value_switch_binding, size_t n_switch_binding);
void vteprec_logical_router_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_logical_router_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_logical_switch_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
void vteprec_logical_switch_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void vteprec_logical_switch_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_logical_switch_add_clause_replication_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *replication_mode);
...
void vteprec_logical_switch_add_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key);
void vteprec_logical_switch_add_clause_true(struct ovsdb_idl *idl);
void vteprec_logical_switch_add_clause_false(struct ovsdb_idl *idl);

void vteprec_logical_switch_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
void vteprec_logical_switch_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void vteprec_logical_switch_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_logical_switch_remove_clause_replication_mode(struct ovsdb_idl *idl, enum ovsdb_function function, const char *replication_mode);
void vteprec_logical_switch_remove_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key);
void vteprec_logical_switch_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_logical_switch_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_manager_add_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe);
void vteprec_manager_add_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected);
...
void vteprec_manager_add_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff);
...
void vteprec_manager_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_manager_add_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_manager_add_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target);
void vteprec_manager_add_clause_true(struct ovsdb_idl *idl);
void vteprec_manager_add_clause_false(struct ovsdb_idl *idl);

void vteprec_manager_remove_clause_inactivity_probe(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *inactivity_probe, size_t n_inactivity_probe);
void vteprec_manager_remove_clause_is_connected(struct ovsdb_idl *idl, enum ovsdb_function function, bool is_connected);
void vteprec_manager_remove_clause_max_backoff(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *max_backoff, size_t n_max_backoff);
void vteprec_manager_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_manager_remove_clause_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_manager_remove_clause_target(struct ovsdb_idl *idl, enum ovsdb_function function, const char *target);
void vteprec_manager_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_manager_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_mcast_macs_local_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_mcast_macs_local_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_mcast_macs_local_add_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set);
void vteprec_mcast_macs_local_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_mcast_macs_local_add_clause_true(struct ovsdb_idl *idl);
void vteprec_mcast_macs_local_add_clause_false(struct ovsdb_idl *idl);

void vteprec_mcast_macs_local_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_mcast_macs_local_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_mcast_macs_local_remove_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set);
void vteprec_mcast_macs_local_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_mcast_macs_local_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_mcast_macs_local_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_mcast_macs_remote_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_mcast_macs_remote_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_mcast_macs_remote_add_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set);
void vteprec_mcast_macs_remote_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_mcast_macs_remote_add_clause_true(struct ovsdb_idl *idl);
void vteprec_mcast_macs_remote_add_clause_false(struct ovsdb_idl *idl);

void vteprec_mcast_macs_remote_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_mcast_macs_remote_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_mcast_macs_remote_remove_clause_locator_set(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator_set);
void vteprec_mcast_macs_remote_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_mcast_macs_remote_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_mcast_macs_remote_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_physical_locator_add_clause_dst_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dst_ip);
void vteprec_physical_locator_add_clause_encapsulation_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *encapsulation_type);
...
void vteprec_physical_locator_add_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key);
void vteprec_physical_locator_add_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_locator_add_clause_false(struct ovsdb_idl *idl);

void vteprec_physical_locator_remove_clause_dst_ip(struct ovsdb_idl *idl, enum ovsdb_function function, const char *dst_ip);
void vteprec_physical_locator_remove_clause_encapsulation_type(struct ovsdb_idl *idl, enum ovsdb_function function, const char *encapsulation_type);
void vteprec_physical_locator_remove_clause_tunnel_key(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *tunnel_key, size_t n_tunnel_key);
void vteprec_physical_locator_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_locator_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_physical_locator_set_add_clause_locators(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **locators, size_t n_locators);
void vteprec_physical_locator_set_add_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_locator_set_add_clause_false(struct ovsdb_idl *idl);

void vteprec_physical_locator_set_remove_clause_locators(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **locators, size_t n_locators);
void vteprec_physical_locator_set_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_locator_set_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_physical_port_add_clause_acl_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_acl_bindings, struct uuid **value_acl_bindings, size_t n_acl_bindings);
void vteprec_physical_port_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
void vteprec_physical_port_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void vteprec_physical_port_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_physical_port_add_clause_port_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **port_fault_status, size_t n_port_fault_status);
...
void vteprec_physical_port_add_clause_vlan_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_bindings, struct uuid **value_vlan_bindings, size_t n_vlan_bindings);
...
void vteprec_physical_port_add_clause_vlan_stats(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_stats, struct uuid **value_vlan_stats, size_t n_vlan_stats);
void vteprec_physical_port_add_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_port_add_clause_false(struct ovsdb_idl *idl);

void vteprec_physical_port_remove_clause_acl_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_acl_bindings, struct uuid **value_acl_bindings, size_t n_acl_bindings);
void vteprec_physical_port_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
void vteprec_physical_port_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void vteprec_physical_port_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_physical_port_remove_clause_port_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **port_fault_status, size_t n_port_fault_status);
void vteprec_physical_port_remove_clause_vlan_bindings(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_bindings, struct uuid **value_vlan_bindings, size_t n_vlan_bindings);
void vteprec_physical_port_remove_clause_vlan_stats(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_vlan_stats, struct uuid **value_vlan_stats, size_t n_vlan_stats);
void vteprec_physical_port_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_port_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_physical_switch_add_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
...
void vteprec_physical_switch_add_clause_management_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **management_ips, size_t n_management_ips);
void vteprec_physical_switch_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void vteprec_physical_switch_add_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_physical_switch_add_clause_ports(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ports, size_t n_ports);
...
void vteprec_physical_switch_add_clause_switch_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **switch_fault_status, size_t n_switch_fault_status);
...
void vteprec_physical_switch_add_clause_tunnel_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **tunnel_ips, size_t n_tunnel_ips);
...
void vteprec_physical_switch_add_clause_tunnels(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **tunnels, size_t n_tunnels);
void vteprec_physical_switch_add_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_switch_add_clause_false(struct ovsdb_idl *idl);

void vteprec_physical_switch_remove_clause_description(struct ovsdb_idl *idl, enum ovsdb_function function, const char *description);
void vteprec_physical_switch_remove_clause_management_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **management_ips, size_t n_management_ips);
void vteprec_physical_switch_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void vteprec_physical_switch_remove_clause_other_config(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_physical_switch_remove_clause_ports(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ports, size_t n_ports);
void vteprec_physical_switch_remove_clause_switch_fault_status(struct ovsdb_idl *idl, enum ovsdb_function function, const char **switch_fault_status, size_t n_switch_fault_status);
void vteprec_physical_switch_remove_clause_tunnel_ips(struct ovsdb_idl *idl, enum ovsdb_function function, const char **tunnel_ips, size_t n_tunnel_ips);
void vteprec_physical_switch_remove_clause_tunnels(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **tunnels, size_t n_tunnels);
void vteprec_physical_switch_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_physical_switch_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_tunnel_add_clause_bfd_config_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_tunnel_add_clause_bfd_config_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_tunnel_add_clause_bfd_params(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
...
void vteprec_tunnel_add_clause_bfd_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_tunnel_add_clause_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *local);
void vteprec_tunnel_add_clause_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *remote);
void vteprec_tunnel_add_clause_true(struct ovsdb_idl *idl);
void vteprec_tunnel_add_clause_false(struct ovsdb_idl *idl);

void vteprec_tunnel_remove_clause_bfd_config_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_tunnel_remove_clause_bfd_config_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_tunnel_remove_clause_bfd_params(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_tunnel_remove_clause_bfd_status(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void vteprec_tunnel_remove_clause_local(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *local);
void vteprec_tunnel_remove_clause_remote(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *remote);
void vteprec_tunnel_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_tunnel_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_ucast_macs_local_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_ucast_macs_local_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_ucast_macs_local_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_ucast_macs_local_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_ucast_macs_local_add_clause_true(struct ovsdb_idl *idl);
void vteprec_ucast_macs_local_add_clause_false(struct ovsdb_idl *idl);

void vteprec_ucast_macs_local_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_ucast_macs_local_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_ucast_macs_local_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_ucast_macs_local_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_ucast_macs_local_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_ucast_macs_local_remove_clause_false(struct ovsdb_idl *idl);
...
void vteprec_ucast_macs_remote_add_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_ucast_macs_remote_add_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_ucast_macs_remote_add_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_ucast_macs_remote_add_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_ucast_macs_remote_add_clause_true(struct ovsdb_idl *idl);
void vteprec_ucast_macs_remote_add_clause_false(struct ovsdb_idl *idl);

void vteprec_ucast_macs_remote_remove_clause_MAC(struct ovsdb_idl *idl, enum ovsdb_function function, const char *MAC);
void vteprec_ucast_macs_remote_remove_clause_ipaddr(struct ovsdb_idl *idl, enum ovsdb_function function, const char *ipaddr);
void vteprec_ucast_macs_remote_remove_clause_locator(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *locator);
void vteprec_ucast_macs_remote_remove_clause_logical_switch(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *logical_switch);
void vteprec_ucast_macs_remote_remove_clause_true(struct ovsdb_idl *idl);
void vteprec_ucast_macs_remote_remove_clause_false(struct ovsdb_idl *idl);
