...
OFPFW_EVNT_VAL1 = 1 << 24
OFPFW_EVNT_VAL2 = 1 << 25
OFPFW_EVNT_TYP = 1 << 26
OFPFW_EVNT_OP1 = 1 << 27
OFPFW_EVNT_OP2 = 1 << 28
...
_OFP_MATCH_PACK_STR = 'IH' + OFP_ETH_ALEN_STR + 's' + OFP_ETH_ALEN_STR + \
                      'sHBxHBB2xIIHHQQQQQQHHHxx'  
OFP_MATCH_PACK_STR = '!' + _OFP_MATCH_PACK_STR 
OFP_MATCH_SIZE = 96 #CEP 46 -> 56 -> 96
...
OFP_FLOW_MOD_SIZE = 128   #CEP 70 -> 88 -> 128
...
OFP_FLOW_REMOVED_SIZE = 144 #CEP 88 -> 104 -> 144
...
OFP_FLOW_STATS_REQUEST_SIZE = 112 #CEP 56 -> 72 ->  112
...
OFP_FLOW_STATS_SIZE = 144 #CEP 88 -> 104 -> 144
...
NXM_OF_UDP_PYD = nxm_header(0x0000, 34, 8)
NXM_OF_UDP_PYD1 = nxm_header(0x0000, 35, 8)
NXM_OF_EVNT_ATTR1 = nxm_header(0x0000, 36, 8)
NXM_OF_EVNT_ATTR2 = nxm_header(0x0000, 37, 8)
NXM_OF_EVNT_VAL1 = nxm_header(0x0000, 38, 8)
NXM_OF_EVNT_VAL2 = nxm_header(0x0000, 39, 8)
NXM_OF_EVNT_TYP = nxm_header(0x0000, 40, 2)
NXM_OF_EVNT_OP1 = nxm_header(0x0000, 41, 2)
NXM_OF_EVNT_OP2 = nxm_header(0x0000, 42, 2)
