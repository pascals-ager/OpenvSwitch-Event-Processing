...
void idltest_link1_add_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i);
void idltest_link1_add_clause_k(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *k);
...
void idltest_link1_add_clause_ka(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ka, size_t n_ka);
...
void idltest_link1_add_clause_l2(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l2);
void idltest_link1_add_clause_true(struct ovsdb_idl *idl);
void idltest_link1_add_clause_false(struct ovsdb_idl *idl);

void idltest_link1_remove_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i);
void idltest_link1_remove_clause_k(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *k);
void idltest_link1_remove_clause_ka(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ka, size_t n_ka);
void idltest_link1_remove_clause_l2(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l2);
void idltest_link1_remove_clause_true(struct ovsdb_idl *idl);
void idltest_link1_remove_clause_false(struct ovsdb_idl *idl);
...
void idltest_link2_add_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i);
...
void idltest_link2_add_clause_l1(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l1);
void idltest_link2_add_clause_true(struct ovsdb_idl *idl);
void idltest_link2_add_clause_false(struct ovsdb_idl *idl);

void idltest_link2_remove_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i);
void idltest_link2_remove_clause_l1(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l1);
void idltest_link2_remove_clause_true(struct ovsdb_idl *idl);
void idltest_link2_remove_clause_false(struct ovsdb_idl *idl);
...
void idltest_simple_add_clause_b(struct ovsdb_idl *idl, enum ovsdb_function function, bool b);
...
void idltest_simple_add_clause_ba(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *ba, size_t n_ba);
void idltest_simple_add_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i);
...
void idltest_simple_add_clause_ia(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ia, size_t n_ia);
void idltest_simple_add_clause_r(struct ovsdb_idl *idl, enum ovsdb_function function, double r);
...
void idltest_simple_add_clause_ra(struct ovsdb_idl *idl, enum ovsdb_function function, const double *ra, size_t n_ra);
void idltest_simple_add_clause_s(struct ovsdb_idl *idl, enum ovsdb_function function, const char *s);
...
void idltest_simple_add_clause_sa(struct ovsdb_idl *idl, enum ovsdb_function function, const char **sa, size_t n_sa);
void idltest_simple_add_clause_u(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid u);
...
void idltest_simple_add_clause_ua(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ua, size_t n_ua);
void idltest_simple_add_clause_true(struct ovsdb_idl *idl);
void idltest_simple_add_clause_false(struct ovsdb_idl *idl);

void idltest_simple_remove_clause_b(struct ovsdb_idl *idl, enum ovsdb_function function, bool b);
void idltest_simple_remove_clause_ba(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *ba, size_t n_ba);
void idltest_simple_remove_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i);
void idltest_simple_remove_clause_ia(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ia, size_t n_ia);
void idltest_simple_remove_clause_r(struct ovsdb_idl *idl, enum ovsdb_function function, double r);
void idltest_simple_remove_clause_ra(struct ovsdb_idl *idl, enum ovsdb_function function, const double *ra, size_t n_ra);
void idltest_simple_remove_clause_s(struct ovsdb_idl *idl, enum ovsdb_function function, const char *s);
void idltest_simple_remove_clause_sa(struct ovsdb_idl *idl, enum ovsdb_function function, const char **sa, size_t n_sa);
void idltest_simple_remove_clause_u(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid u);
void idltest_simple_remove_clause_ua(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ua, size_t n_ua);
void idltest_simple_remove_clause_true(struct ovsdb_idl *idl);
void idltest_simple_remove_clause_false(struct ovsdb_idl *idl);
...
void idltest_simple2_add_clause_imap(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_imap, const char **value_imap, size_t n_imap);
void idltest_simple2_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void idltest_simple2_add_clause_smap(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void idltest_simple2_add_clause_true(struct ovsdb_idl *idl);
void idltest_simple2_add_clause_false(struct ovsdb_idl *idl);

void idltest_simple2_remove_clause_imap(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_imap, const char **value_imap, size_t n_imap);
void idltest_simple2_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void idltest_simple2_remove_clause_smap(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *);
void idltest_simple2_remove_clause_true(struct ovsdb_idl *idl);
void idltest_simple2_remove_clause_false(struct ovsdb_idl *idl);
...
void idltest_simple3_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
...
void idltest_simple3_add_clause_uref(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **uref, size_t n_uref);
...
void idltest_simple3_add_clause_uset(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *uset, size_t n_uset);
void idltest_simple3_add_clause_true(struct ovsdb_idl *idl);
void idltest_simple3_add_clause_false(struct ovsdb_idl *idl);

void idltest_simple3_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void idltest_simple3_remove_clause_uref(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **uref, size_t n_uref);
void idltest_simple3_remove_clause_uset(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *uset, size_t n_uset);
void idltest_simple3_remove_clause_true(struct ovsdb_idl *idl);
void idltest_simple3_remove_clause_false(struct ovsdb_idl *idl);
...
void idltest_simple4_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void idltest_simple4_add_clause_true(struct ovsdb_idl *idl);
void idltest_simple4_add_clause_false(struct ovsdb_idl *idl);

void idltest_simple4_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name);
void idltest_simple4_remove_clause_true(struct ovsdb_idl *idl);
void idltest_simple4_remove_clause_false(struct ovsdb_idl *idl);
