...
OFP_ASSERT(sizeof(struct ofp10_match) == 64);
...
OFP_ASSERT(sizeof(struct ofp10_flow_mod) == 88);
...
OFP_ASSERT(sizeof(struct ofp10_flow_removed) == 104);
...
OFP_ASSERT(sizeof(struct ofp10_flow_stats_request) == 72);
...
OFP_ASSERT(sizeof(struct ofp10_flow_stats) == 120);
