...
class OFPMatch(StringifyMixin):
    ...
    def __init__(self, wildcards=None, in_port=None, dl_src=None, dl_dst=None,
                 ...
                 tp_src=None, tp_dst=None, udp_pyd=None, udp_pyd1=None, nw_src_mask=32, nw_dst_mask=32):
        ...
        #CEP 
        '''
        Debug why udp_pyd and udp_pyd1 is parsed as None.
        For now, I am passing values of 30 and 31.
        ...
        LOG.debug('VLOG In ofproto_v1_0_parser OFPMatch point -3 self.wildcards - %d', self.wildcards) #CEP      
    ...
    def serialize(self, buf, offset):
        LOG.debug('VLOG in OFPMatch serialize') #CEP
...
class OFPFlowMod(MsgBase):
    ...
    def _serialize_body(self):
        offset = ofproto.OFP_HEADER_SIZE
        LOG.debug('VLOG In OFPFlowmod - Next match serialize')
