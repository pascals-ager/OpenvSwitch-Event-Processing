...
idltest_link1_update_ka_addvalue(const struct idltest_link1 *row, const struct idltest_link1 *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_link1_columns[IDLTEST_LINK1_COL_KA],
                                    datum);
}
...
idltest_link1_update_l2_addvalue(const struct idltest_link1 *row, const struct idltest_link2 *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_link1_columns[IDLTEST_LINK1_COL_L2],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_add_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.integer = i;
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK1],
                          function,
                          &idltest_link1_columns[IDLTEST_LINK1_COL_I],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_add_clause_k(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *k)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK1],
                          function,
                          &idltest_link1_columns[IDLTEST_LINK1_COL_K],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_add_clause_ka(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ka, size_t n_ka)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_add_clause_l2(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l2)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
idltest_link1_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK1], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_link1_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK1], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_remove_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.integer = i;
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK1],
                          function,
                          &idltest_link1_columns[IDLTEST_LINK1_COL_I],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_remove_clause_k(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *k)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_remove_clause_ka(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **ka, size_t n_ka)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link1_remove_clause_l2(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l2)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
idltest_link1_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK1], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_link1_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK1], OVSDB_F_TRUE, NULL, &datum);
}
...
idltest_link2_update_l1_addvalue(const struct idltest_link2 *row, const struct idltest_link1 *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_link2_columns[IDLTEST_LINK2_COL_L1],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link2_add_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.integer = i;
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK2],
                          function,
                          &idltest_link2_columns[IDLTEST_LINK2_COL_I],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link2_add_clause_l1(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l1)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
idltest_link2_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK2], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_link2_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK2], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link2_remove_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.integer = i;
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK2],
                          function,
                          &idltest_link2_columns[IDLTEST_LINK2_COL_I],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_link2_remove_clause_l1(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *l1)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
...
void
idltest_link2_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK2], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_link2_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_LINK2], OVSDB_F_TRUE, NULL, &datum);
}
...
idltest_simple_update_ba_addvalue(const struct idltest_simple *row, bool new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_simple_columns[IDLTEST_SIMPLE_COL_BA],
                                    datum);
}
...
idltest_simple_update_ia_addvalue(const struct idltest_simple *row, int64_t new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_simple_columns[IDLTEST_SIMPLE_COL_IA],
                                    datum);
}
...
idltest_simple_update_ra_addvalue(const struct idltest_simple *row, double new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_simple_columns[IDLTEST_SIMPLE_COL_RA],
                                    datum);
}
...
idltest_simple_update_sa_addvalue(const struct idltest_simple *row, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_simple_columns[IDLTEST_SIMPLE_COL_SA],
                                    datum);
}
...
idltest_simple_update_ua_addvalue(const struct idltest_simple *row, struct uuid new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_simple_columns[IDLTEST_SIMPLE_COL_UA],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_b(struct ovsdb_idl *idl, enum ovsdb_function function, bool b)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.boolean = b;
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE],
                          function,
                          &idltest_simple_columns[IDLTEST_SIMPLE_COL_B],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_ba(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *ba, size_t n_ba)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE],
                          function,
                          &idltest_simple_columns[IDLTEST_SIMPLE_COL_I],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_ia(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ia, size_t n_ia)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_r(struct ovsdb_idl *idl, enum ovsdb_function function, double r)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE],
                          function,
                          &idltest_simple_columns[IDLTEST_SIMPLE_COL_R],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_ra(struct ovsdb_idl *idl, enum ovsdb_function function, const double *ra, size_t n_ra)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_s(struct ovsdb_idl *idl, enum ovsdb_function function, const char *s)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE],
                          function,
                          &idltest_simple_columns[IDLTEST_SIMPLE_COL_S],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_sa(struct ovsdb_idl *idl, enum ovsdb_function function, const char **sa, size_t n_sa)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_u(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid u)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE],
                          function,
                          &idltest_simple_columns[IDLTEST_SIMPLE_COL_U],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_add_clause_ua(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ua, size_t n_ua)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
idltest_simple_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_b(struct ovsdb_idl *idl, enum ovsdb_function function, bool b)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.boolean = b;
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE],
                          function,
                          &idltest_simple_columns[IDLTEST_SIMPLE_COL_B],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_ba(struct ovsdb_idl *idl, enum ovsdb_function function, const bool *ba, size_t n_ba)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_i(struct ovsdb_idl *idl, enum ovsdb_function function, int64_t i)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_ia(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *ia, size_t n_ia)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_r(struct ovsdb_idl *idl, enum ovsdb_function function, double r)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_ra(struct ovsdb_idl *idl, enum ovsdb_function function, const double *ra, size_t n_ra)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_s(struct ovsdb_idl *idl, enum ovsdb_function function, const char *s)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_sa(struct ovsdb_idl *idl, enum ovsdb_function function, const char **sa, size_t n_sa)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_u(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid u)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple_remove_clause_ua(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *ua, size_t n_ua)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
idltest_simple_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE], OVSDB_F_TRUE, NULL, &datum);
}
...
{
    return idltest_simple2_cast(ovsdb_idl_get_row_for_uuid(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2], uuid));
}
...
{
    return idltest_simple2_cast(ovsdb_idl_first_row(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2]));
}
...
{
    return ovsdb_idl_table_get_seqno(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2]);
}
...
{
    return idltest_simple2_cast(ovsdb_idl_track_get_first(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2]));
}
...
{
    return idltest_simple2_cast(ovsdb_idl_txn_insert(txn, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2], NULL));
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_IMAP]);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_NAME]);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_SMAP]);
}
...
idltest_simple2_set_imap(const struct idltest_simple2 *row, const int64_t *key_imap, const char **value_imap, size_t n_imap)
{
    ...
    ovsdb_idl_txn_write(&row->header_, &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_IMAP], &datum);
}
...
idltest_simple2_set_name(const struct idltest_simple2 *row, const char *name)
{
    ...
    datum.values = NULL;
    ovsdb_idl_txn_write_clone(&row->header_, &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_NAME], &datum);
}
...
idltest_simple2_update_imap_setkey(const struct idltest_simple2 *row, int64_t new_key, const char *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_map(&row->header_,
                                    &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_IMAP],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple2_add_clause_imap(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_imap, const char **value_imap, size_t n_imap)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_INTEGER, OVSDB_TYPE_STRING);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2],
                          function,
                          &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_IMAP],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple2_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2],
                          function,
                          &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_NAME],
                          &datum);
}
 ...
 * The caller retains ownership of 'smap' and everything in it. */
void
idltest_simple2_add_clause_smap(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *smap)
{
    struct ovsdb_datum datum;
...
void
idltest_simple2_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple2_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple2_remove_clause_imap(struct ovsdb_idl *idl, enum ovsdb_function function, const int64_t *key_imap, const char **value_imap, size_t n_imap)
{
    struct ovsdb_datum datum;
    size_t i;
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_INTEGER, OVSDB_TYPE_STRING);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2],
                          function,
                          &idltest_simple2_columns[IDLTEST_SIMPLE2_COL_IMAP],
                          &datum);
    free(datum.keys);
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple2_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
 ...
 * The caller retains ownership of 'smap' and everything in it. */
void
idltest_simple2_remove_clause_smap(struct ovsdb_idl *idl, enum ovsdb_function function, const struct smap *smap)
{
    struct ovsdb_datum datum;
...
void
idltest_simple2_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple2_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE2], OVSDB_F_TRUE, NULL, &datum);
}

struct ovsdb_idl_column idltest_simple2_columns[IDLTEST_SIMPLE2_N_COLUMNS];

static void
idltest_simple2_columns_init(void)
{
    struct ovsdb_idl_column *c;

    /* Initialize idltest_simple2_col_imap. */
    c = &idltest_simple2_col_imap;
    c->name = "imap";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_INTEGER);
    ...
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = idltest_simple2_parse_imap;
    c->unparse = idltest_simple2_unparse_imap;

    /* Initialize idltest_simple2_col_name. */
    c = &idltest_simple2_col_name;
    c->name = "name";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_VOID);
    ...
    c->type.n_max = 1;
    c->mutable = true;
    c->parse = idltest_simple2_parse_name;
    c->unparse = idltest_simple2_unparse_name;

    /* Initialize idltest_simple2_col_smap. */
    c = &idltest_simple2_col_smap;
    c->name = "smap";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_STRING);
    ...
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = idltest_simple2_parse_smap;
    c->unparse = idltest_simple2_unparse_smap;
}

/* simple3 table. */
...
idltest_simple3_parse_uref(struct ovsdb_idl_row *row_, const struct ovsdb_datum *datum)
{
    ...
    row->n_uref = 0;
    for (i = 0; i < datum->n; i++) {
        struct idltest_simple4 *keyRow = idltest_simple4_cast(ovsdb_idl_get_row_arc(row_, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4], &datum->keys[i].uuid));
        if (keyRow) {
            if (!row->n_uref) {
...
{
    return idltest_simple3_cast(ovsdb_idl_get_row_for_uuid(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3], uuid));
}
...
{
    return idltest_simple3_cast(ovsdb_idl_first_row(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3]));
}
...
{
    return ovsdb_idl_table_get_seqno(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3]);
}
...
{
    return idltest_simple3_cast(ovsdb_idl_track_get_first(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3]));
}
...
{
    return idltest_simple3_cast(ovsdb_idl_txn_insert(txn, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3], NULL));
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_NAME]);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_UREF]);
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_USET]);
}
...
idltest_simple3_set_name(const struct idltest_simple3 *row, const char *name)
{
    ...
    key.string = CONST_CAST(char *, name);
    datum.values = NULL;
    ovsdb_idl_txn_write_clone(&row->header_, &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_NAME], &datum);
}
...
idltest_simple3_set_uref(const struct idltest_simple3 *row, struct idltest_simple4 **uref, size_t n_uref)
{
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_txn_write(&row->header_, &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_UREF], &datum);
}
...
idltest_simple3_set_uset(const struct idltest_simple3 *row, const struct uuid *uset, size_t n_uset)
{
    ...
    ovsdb_datum_sort_unique(&datum, OVSDB_TYPE_UUID, OVSDB_TYPE_VOID);
    ovsdb_idl_txn_write(&row->header_, &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_USET], &datum);
}
...
idltest_simple3_update_uref_addvalue(const struct idltest_simple3 *row, const struct idltest_simple4 *new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_UREF],
                                    datum);
}
...
idltest_simple3_update_uset_addvalue(const struct idltest_simple3 *row, struct uuid new_value)
{
    ...
    ovsdb_idl_txn_write_partial_set(&row->header_,
                                    &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_USET],
                                    datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple3_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, name);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3],
                          function,
                          &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_NAME],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple3_add_clause_uref(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **uref, size_t n_uref)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple3_add_clause_uset(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *uset, size_t n_uset)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
idltest_simple3_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple3_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple3_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, name);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3],
                          function,
                          &idltest_simple3_columns[IDLTEST_SIMPLE3_COL_NAME],
                          &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple3_remove_clause_uref(struct ovsdb_idl *idl, enum ovsdb_function function, struct uuid **uref, size_t n_uref)
{
    struct ovsdb_datum datum;
    size_t i;
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple3_remove_clause_uset(struct ovsdb_idl *idl, enum ovsdb_function function, const struct uuid *uset, size_t n_uset)
{
    struct ovsdb_datum datum;
    size_t i;
...
void
idltest_simple3_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple3_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE3], OVSDB_F_TRUE, NULL, &datum);
}

struct ovsdb_idl_column idltest_simple3_columns[IDLTEST_SIMPLE3_N_COLUMNS];

static void
idltest_simple3_columns_init(void)
{
    struct ovsdb_idl_column *c;

    /* Initialize idltest_simple3_col_name. */
    c = &idltest_simple3_col_name;
    c->name = "name";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_VOID);
    ...
    c->type.n_max = 1;
    c->mutable = true;
    c->parse = idltest_simple3_parse_name;
    c->unparse = idltest_simple3_unparse_name;

    /* Initialize idltest_simple3_col_uref. */
    c = &idltest_simple3_col_uref;
    c->name = "uref";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_UUID);
    c->type.key.u.uuid.refTableName = "simple4";
    c->type.key.u.uuid.refType = OVSDB_REF_STRONG;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_VOID);
    c->type.n_min = 0;
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = idltest_simple3_parse_uref;
    c->unparse = idltest_simple3_unparse_uref;

    /* Initialize idltest_simple3_col_uset. */
    c = &idltest_simple3_col_uset;
    c->name = "uset";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_UUID);
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_VOID);
    c->type.n_min = 0;
    c->type.n_max = UINT_MAX;
    c->mutable = true;
    c->parse = idltest_simple3_parse_uset;
    c->unparse = idltest_simple3_unparse_uset;
}

/* simple4 table. */
...
{
    return idltest_simple4_cast(ovsdb_idl_get_row_for_uuid(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4], uuid));
}
...
{
    return idltest_simple4_cast(ovsdb_idl_first_row(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4]));
}
...
{
    return ovsdb_idl_table_get_seqno(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4]);
}
...
{
    return idltest_simple4_cast(ovsdb_idl_track_get_first(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4]));
}
...
{
    return idltest_simple4_cast(ovsdb_idl_txn_insert(txn, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4], NULL));
}
...
{
    ovs_assert(inited);
    ovsdb_idl_txn_verify(&row->header_, &idltest_simple4_columns[IDLTEST_SIMPLE4_COL_NAME]);
}
...
idltest_simple4_set_name(const struct idltest_simple4 *row, const char *name)
{
    ...
    key.string = CONST_CAST(char *, name);
    datum.values = NULL;
    ovsdb_idl_txn_write_clone(&row->header_, &idltest_simple4_columns[IDLTEST_SIMPLE4_COL_NAME], &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple4_add_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, name);
    datum.values = NULL;
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4],
                          function,
                          &idltest_simple4_columns[IDLTEST_SIMPLE4_COL_NAME],
                          &datum);
}
void
idltest_simple4_add_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple4_add_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_add_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4], OVSDB_F_TRUE, NULL, &datum);
}
 ...
 * The caller retains ownership of the arguments. */
void
idltest_simple4_remove_clause_name(struct ovsdb_idl *idl, enum ovsdb_function function, const char *name)
{
    struct ovsdb_datum datum;
    union ovsdb_atom key;
    ...
    key.string = CONST_CAST(char *, name);
    datum.values = NULL;
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4],
                          function,
                          &idltest_simple4_columns[IDLTEST_SIMPLE4_COL_NAME],
                          &datum);
}
void
idltest_simple4_remove_clause_false(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4], OVSDB_F_FALSE, NULL, &datum);
}
void
idltest_simple4_remove_clause_true(struct ovsdb_idl *idl)
{
    struct ovsdb_datum datum;

    ovsdb_datum_init_empty(&datum);
    ovsdb_idl_condition_remove_clause(idl, &idltest_table_classes[IDLTEST_TABLE_SIMPLE4], OVSDB_F_TRUE, NULL, &datum);
}

struct ovsdb_idl_column idltest_simple4_columns[IDLTEST_SIMPLE4_N_COLUMNS];

static void
idltest_simple4_columns_init(void)
{
    struct ovsdb_idl_column *c;

    /* Initialize idltest_simple4_col_name. */
    c = &idltest_simple4_col_name;
    c->name = "name";
    ovsdb_base_type_init(&c->type.key, OVSDB_TYPE_STRING);
    c->type.key.u.string.minLen = 0;
    ovsdb_base_type_init(&c->type.value, OVSDB_TYPE_VOID);
    ...
    c->type.n_max = 1;
    c->mutable = true;
    c->parse = idltest_simple4_parse_name;
    c->unparse = idltest_simple4_unparse_name;
}

...
idltest_init(void)
{
    ...
    idltest_simple2_columns_init();
    idltest_simple3_columns_init();
    idltest_simple4_columns_init();
}
