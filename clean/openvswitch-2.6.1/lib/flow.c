...
/*CEP */
#define miniflow_push_be64(MF, FIELD, VALUE)                        \
    miniflow_push_be64_(MF, offsetof(struct flow, FIELD), VALUE)
...
/* Here goes the biggggggg snippet*/
                miniflow_push_be64(mf, e_type, htonll(0));                   
                miniflow_push_be64(mf, e_attr1, htonll(0));
                miniflow_push_be64(mf, e_attr2, htonll(0));  
